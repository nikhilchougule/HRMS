...
-------------------------------------------FOREGIN KEYS
--[User]
ALTER TABLE [User]  WITH NOCHECK ADD  CONSTRAINT [FK_User_Role] FOREIGN KEY([RoleID]) REFERENCES [Role]([ID])
GO
...
--Test
--[UserID.User.ID]  [CreatedByID.User.ID] [TestResultID.TestResult.ID]
...
ALTER TABLE [Test] WITH NOCHECK ADD CONSTRAINT [FK_Test_Status] FOREIGN KEY ([StatusID]) REFERENCES [Status]([ID]) 
GO
