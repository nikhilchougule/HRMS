...
export class CommonAuthGuard implements CanActivate, CanActivateChild {
  serverToken: any;
  clientToken: any;
  _authService: any;
  _storageService: any;
  ...
  canActivate(): boolean {
    ...
    console.log('in common auth guard jwt token' + this.localStorageService.getItem('JwtToken'));
