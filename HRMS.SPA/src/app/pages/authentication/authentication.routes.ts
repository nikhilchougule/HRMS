...
import { AppSideRegisterApplicantComponent } from './side-register-applicant/side-register-applicant.component';
...
export const AuthenticationRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'side-register-applicant',
        component: AppSideRegisterApplicantComponent,
      },
      {
        path: 'side-two-steps',
