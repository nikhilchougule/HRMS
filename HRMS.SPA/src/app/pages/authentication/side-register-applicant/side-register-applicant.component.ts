...
@Component({
  ...
  templateUrl: './side-register-applicant.component.html'
})

export class AppSideRegisterApplicantComponent {
  ...
  submit() {
    if (this.form.valid) {
      ...
      let returnFromService = this._authService.signUpApplicantObservable(userSubmitForm)
        .subscribe(response => {
