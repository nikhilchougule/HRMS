...
import { ContactList } from 'src/app/pages/contact-list/contactlistData';
import {
  Category,
  filter,
  label,
} from 'src/app/pages/contact-list/listing/categories';
import { ContactBox } from 'src/app/pages/contact-list/contact-list';
